...
/**
 * Test case for class Tx_Nit_kundenstimmen_Controller_KundenstimmenController.
 *
 * @version $Id$
 ...
 */
class KundenstimmenControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
